...
const IssuCard = ({ d }) => {
    ...
    return (
        <div className="w-full sm:max-w-sm md:max-w-md mx-auto bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
            ...
            <div className="flex items-center justify-between mb-5">
                <div className="flex items-center gap-3 group relative">
                    ...
                    {/* Tooltip */}
                    <span className="absolute -bottom-7 left-1/2 -translate-x-1/2 scale-0 group-hover:scale-100 transition-all bg-gray-900 text-white text-[11px] px-2 py-[2px] rounded">
                        {requestedBy}
                    </span>
