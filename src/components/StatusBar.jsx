            ...
            <div className="py-10">
                <div className="px-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                        ...
                        {/* Pending */}
                        <div className="bg-slate-600 text-white rounded-lg p-10 text-center shadow-md hover:shadow-xl transition-shadow duration-300">
                            <h2 className="text-3xl font-semibold">Pending</h2>
                            <p className="text-xl mt-2">{pendingData.length}</p>
                        </div>

                        {/* Submitted */}
                        <div className="bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-lg p-10 text-center shadow-md hover:shadow-xl transition-shadow duration-300">
                            <h2 className="text-3xl font-semibold">Submitted</h2>
                            <p className="text-xl mt-2">{submittedData.length}</p>
                        </div>

                        {/* Reviewed */}
                        <div className="bg-teal-500 text-white rounded-lg p-10 text-center shadow-md hover:shadow-xl transition-shadow duration-300">
